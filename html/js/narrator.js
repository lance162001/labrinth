...
const NARRATOR = {
  ...
  signup:            { onPredRight:"The user clicks Get Started Free — starting the account creation process! 🎉", lines:["The user clicks Get Started Free and the account creation process begins. There are seven steps — I'll be right here throughout! The narrator will also be right here throughout."], prediction:{scene:'signup_2',text:"Step 2 is password creation. I'll let you know if you need anything!"} },
  ...
  verify_bypass:     { lines:["The user clicks Verify a third time and the system decides to proceed anyway, logging a behavioral anomaly that has been added permanently to the account record. The narrator notes the word 'anomaly.' The system chose it."], prediction:{scene:'onboard_start',text:"An onboarding wizard is about to begin. Eight steps."} },
