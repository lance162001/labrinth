...
function scene_blog() {
  ...
  <div style="background:#f1f1f1;min-height:100vh;font-family:Georgia,serif">
    ...
    <div style="max-width:980px;margin:0 auto;padding:1.5rem 1rem;display:grid;grid-template-columns:1fr 230px;gap:1.5rem">
      <div>
        ${[
          ['The Future of Productivity Is Here (And It Is Us)','April 4, 2009','admin','Productivity, Synergy','It is with great pride that we announce the launch of the official Nexus Blog. Here, we will share thought leadership content, tips, and insights about productivity and digital transformation. We believe the future of work is collaborative. We are here to help you navigate it. Please subscribe.'],
          ['10 Tips for Maximum Synergy in the Modern Workplace','March 18, 2009','jordanp','Tips, Strategy','Synergy. It\'s a word we hear a lot. But what does it really mean? In this post, we explore 10 actionable tips for creating a truly synergistic environment. Tip 1: Communicate. Tip 2: Communicate more. Tip 3: Have you considered switching to a platform like Nexus?'],
          ['Why Your Current Tools Are Actively Failing You','February 28, 2009','admin','Industry Insights','Are you still using spreadsheets? Email? Post-it notes? Legacy tools cannot keep up with the pace of the modern knowledge worker. Nexus was built from the ground up to solve the problems you didn\'t know you had. We did the research. You don\'t have to.'],
          ['Hello World!','January 1, 2009','admin','Uncategorized','Welcome to the Nexus Blog. This is our first post. We are excited to share updates, news, and thought leadership content in the coming months. Stay tuned. Good things are coming.'],
        ].map(([title,date,author,cats,excerpt])=>`
        <div class="wp-post">
          <div class="wp-title">${title}</div>
          <div class="wp-meta">Posted on ${date} by <a data-go="signin" style="color:#21759B;cursor:pointer">${author}</a> | Filed under: <a data-go="blog" style="color:#21759B;cursor:pointer">${cats}</a> | <a data-go="signin" style="color:#21759B;cursor:pointer">4 Comments</a></div>
          <div class="wp-excerpt">${excerpt}</div>
          <div style="margin-top:.75rem;font-size:.78rem;font-family:Arial"><a data-go="signin" style="color:#21759B;cursor:pointer">Read more »</a></div>
        </div>`).join('')}
      ...
      <div>
        ...
        <div style="background:#fff;border:1px solid #ddd;padding:.85rem;margin-bottom:1rem">
          ...
          ${['The Future of Productivity Is Here','10 Tips for Maximum Synergy','Why Your Current Tools Are Failing You','Hello World!'].map(t=>`<div style="font-size:.78rem;padding:.18rem 0"><a data-go="signin" style="color:#21759B;cursor:pointer">» ${t}</a></div>`).join('')}
        </div>
        <div style="background:#fff;border:1px solid #ddd;padding:.85rem;margin-bottom:1rem">
