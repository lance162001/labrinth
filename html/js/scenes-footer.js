...
function scene_terms() {
  ...
  const sections = [
    ...
    ['4. Acceptable Use','You agree not to use Nexus for any unlawful purpose or in any way that could damage, disable, or impair Nexus. You agree not to attempt to gain unauthorized access to any part of Nexus. You agree not to instruct third parties to request account deletion on your behalf.'],
